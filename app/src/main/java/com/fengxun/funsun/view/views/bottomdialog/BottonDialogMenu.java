...
public class BottonDialogMenu extends BaseBottomDialog {
    ...
    public void bindView(View v) {
        ...
        texTitle = (TextView) v.findViewById(R.id.botton_title);
        recyclerView.setAdapter(new BottonDialogMenu.MyAdapter(getContext()));
    ...
    public void setTexTitle(String title,boolean fakeBold){
        if (texTitle==null){
            return;
        }
        if (fakeBold){
            texTitle.getPaint().setFakeBoldText(true);
        }
